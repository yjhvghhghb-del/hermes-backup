...
|---------|--------|---------------|----------------------|
| `default` (主bot) | `cli_aae7a0320738dbeb` | `<LARK_SECRET_1>` | Group A |
| `libai` (理财Bot) | `cli_aafa2c6a83b85bee` | `<LARK_SECRET_2>` | Group B |
| `licai` | `cli_aafa2c6a83b85bee` | `<LARK_SECRET_2>` | Group B — COLLIDES with libai |
| `cutegirl` (妹妹) | `cli_aae7a3ad78b8dbe3` | `<LARK_SECRET_4>` | Group C — COLLIDES with wenyu |
| `wenyu` (文娱写作bot) | `cli_aae7a3ad78b8dbe3` | `<LARK_SECRET_3>` | Group C — COLLIDES with cutegirl |
...
- `default` (主bot) — app_id `cli_aae7a0320738dbeb`, feishu_secret `<LARK_SECRET_1>` ✅
  - **Also has Telegram (`8800919754:AAFdNkpAGSI6M5ahwd3_5g-SuZzusH7ybp4`) and QQ (App ID `1905311551`)**
- `libai` (理财Bot) — app_id `cli_aafa2c6a83b85bee`, feishu_secret `<LARK_SECRET_2>` ✅
- `licai` — app_id `cli_aafa2c6a83b85bee` ⚠️ COLLIDES with libai (same app_id)
- `cutegirl` (妹妹) — app_id `cli_aae7a3ad78b8dbe3`, feishu_secret `<LARK_SECRET_4>` ⚠️ COLLIDES with wenyu (same app_id)
- `wenyu` (文娱写作bot, 活泼性格) — app_id `cli_aae7a3ad78b8dbe3`, feishu_secret `<LARK_SECRET_3>` ⚠️ COLLIDES with cutegirl (same app_id)
